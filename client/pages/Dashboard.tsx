  ...
  import { DEFAULT_PAGE_SIZE, fetchAllPaginated, paginate } from "@/helpers/pagination.helper";
      ...
      const fetchDashboardData = async () => {
        ...
        try {
            const [
              ...
              fetchAllPaginated((page, limit) =>
                getMedicineMovements({ page, limit, days: 7 }).then(
                  (res) => res,
                ),
              ),

              fetchAllPaginated((page, limit) =>
                getInputMovements({ page, limit, days: 7 }).then(
                  (res) => res,
                ),
              ),
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="flex justify-center gap-2 mt-4">
                    ...
                    <button
                      className="px-3 py-1 text-sm border rounded disabled:opacity-50"
                      disabled={nonMovementPage * DEFAULT_PAGE_SIZE >= nonMovementProducts.length}
                      onClick={() => setNonMovementPage((p) => p + 1)}
                    >
                      Próximo
                    </button>
                ...
                <CardContent>
                  ...
                  />
                    <div className="flex justify-center gap-2 mt-4">
                      ...
                      <button
                        className="px-3 py-1 text-sm border rounded disabled:opacity-50"
                        disabled={recentMovementsPage * DEFAULT_PAGE_SIZE >= recentMovements.length}
                        onClick={() => setRecentMovementsPage((p) => p + 1)}
                      >
                        Próximo
                      </button>
